...
if(isset($_POST['add'])){
$querybord="insert into spl_invoice (client,project,email,tax,client_address,billing_address,estimate_date,expire_date,status,othet_information,admin_id,ac_id) values('$client','$project','$email','$tax','$client_address','$billing_address','$estimate_date','$expire_date','1','$othet_information','$cont_hr_id','$ac_id')";
...
$sql_prod="select * from project WHERE id=$item";
$result_prod=mysqli_query($link,$sql_prod);
$list_prod=mysqli_fetch_array($result_prod);
$dril_prod = $list_prod['inventory'] - $qty;
$queryqea="update project SET inventory='$dril_prod' WHERE id=$item";
mysqli_query($link,$queryqea);
}
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<?php if($list_account_permission['invoice_wr']=='on' || $customerchechlogin_row['account_type'] == '1'){?>
							<div class="col-auto float-right ml-auto">
								<a href="invoice_form.php" class="btn add-btn"><i class="fa fa-plus"></i> Create Invoice</a>
							</div>
							<?php } ?>
						</div>
					</div>
						...
						<div class="col-sm-6 col-md-3"> 
							<div class="form-group form-focus select-focus">
								<select class="select floating" name="search_employe"> 
									...
									<?php 
												$sqlclient="select * from clients WHERE admin_id=$cont_hr_id and status='1'";
							...
							<div class="table-responsive">
								<table class="table table-striped custom-table mb-0">
									...
									<tbody>
										...
										<?php
										$k= 1;
										$SQLestimate="select * from spl_invoice WHERE admin_id=$cont_hr_id and client LIKE '%$search_employe%' $bwch order by estimate_id DESC";
...
<a class="dropdown-item" href="#" data-toggle="modal" data-target="#approve_leave<?php echo $estimate_id;?>"><i class="fa fa-dot-circle-o text-info"></i> Pending</a>
<a class="dropdown-item" href="#" data-toggle="modal" data-target="#approve_leave<?php echo $estimate_id;?>"><i class="fa fa-dot-circle-o text-success"></i> Paid</a>
						...
						<div class="modal-content">
							<div class="modal-body">
								...
								<div class="modal-btn delete-action">
									<div class="row">
										<div class="col-6">
<a href="invoice.php?aprove=<?php echo $estimate_id;?>" class="btn btn-primary continue-btn">Payment accept</a>
										</div>
										<div class="col-6">
<a href="invoice.php?decline=<?php echo $estimate_id;?>" class="btn btn-primary cancel-btn">Payment pending</a>
										</div>
									</div>
								</div>
							</div>
											...
											<td class="text-right">
												<div class="dropdown dropdown-action">
													...
													<div class="dropdown-menu dropdown-menu-right">
														<?php if($list_account_permission['invoice_red']=='on' || $customerchechlogin_row['account_type'] == '1'){?>
														<a class="dropdown-item" href="invoice_form.php?edit=<?php echo $estimate_id;?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
														<?php } ?>
														<?php if($list_account_permission['invoice_del']=='on' || $customerchechlogin_row['account_type'] == '1'){?>
						...
						<div class="modal-content">
							<div class="modal-body">
								...
								<div class="modal-btn delete-action">
									<div class="row">
										<div class="col-6">
											<a href="invoice.php?del=<?php echo $estimate_id;?>" class="btn btn-primary continue-btn">Delete</a>
										</div>
										<div class="col-6">
