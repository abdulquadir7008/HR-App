...
{
$querybord="insert into leave_tbl (user_employee,leave_type,date_from,date_to,leave_reason,lb_status,homecontact,image3,admin_id,hr_id) 
values('$user_employee','$leave_type','$date_from','$date_to','$leave_reason','2','$homecontact','$image0','$cont_hr_id','$hr_id')";
