        ...
        <div class="main-wrapper">
		  ...
		  <?php }else{ ?>
			  ...
			  <?php } ?>
							...
							<?php if($list_employee_permission['leave_em_per_wr']=='on' || $customerchechlogin_row['account_type'] == '1'){?>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="stats-info">
								<h6>Take Leaves</h6>
								<?php
	$leave_tbl_sql="select * from leave_tbl  LEFT JOIN users ON leave_tbl.user_employee=users.id WHERE admin_id='$cont_hr_id' and user_employee='$userID'";
											...
											<td class="text-right">
												<div class="dropdown dropdown-action">
													...
													<div class="dropdown-menu dropdown-menu-right">
														<?php if($list_employee_permission['leave_em_per_red']=='on' || $customerchechlogin_row['account_type'] == '1'){?>
<a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_leave<?php echo $leave_tbl_row['leave_id'];?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
														<?php } ?>
														<?php if($list_employee_permission['leave_em_per_del']=='on' || $customerchechlogin_row['account_type'] == '1'){?>
