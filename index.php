							...
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										<h3><?php $SQDepart="select * from project WHERE admin_id='$cont_hr_id' and status='1'"; $ResultDepart=mysqli_query($link,$SQDepart); echo mysqli_num_rows($ResultDepart); ?></h3>
										<span>Projects</span>
									</div>
								</div>
							</div>
						...
						<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										<h3><?php $sqlclientcount="select * from clients WHERE admin_id='$cont_hr_id' and status='1'"; $resultclientcount=mysqli_query($link,$sqlclientcount); echo mysqli_num_rows($resultclientcount); ?></h3>
										<span>Clients</span>
									</div>
								</div>
							</div>
						...
						<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										<h3><?php $sqltaskcount="select * from task_board WHERE admin_id='$cont_hr_id' and status='1'"; $resultaskcount=mysqli_query($link,$sqltaskcount); echo mysqli_num_rows($resultaskcount); ?></h3>
										<span>Tasks</span>
									</div>
								</div>
							</div>
						...
						<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										<h3><?php $sqltaskcount="select * from users WHERE parent_admin='$cont_hr_id' and  status='1'"; $resultaskcount=mysqli_query($link,$sqltaskcount); echo mysqli_num_rows($resultaskcount); ?></h3>
										<span>Employees</span>
									</div>
								</div>
							</div>
