                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<?php if($list_hr_permission['employee_wr']=='on' || $customerchechlogin_row['account_type'] == '1'){?>
					...
					<div class="row filter-row">
						...
						<div class="col-sm-6 col-md-3"> 
                          ...
                          <?php
                           $counter_sql="select * from counter where admin_id='$cont_hr_id' order by countr ASC";
					  ...
					  <img class="inline-block" src="assets\img\user.jpg" alt="user">
								...
								<div class="dropdown profile-action">
									...
									<div class="dropdown-menu dropdown-menu-right">
										<?php if($list_hr_permission['employee_red']=='on' || $customerchechlogin_row['account_type'] == '1'){?>
										...
										<?php }?>
										<?php if($list_hr_permission['employee_del']=='on' || $customerchechlogin_row['account_type'] == '1'){?>
					...
					<div class="modal-dialog modal-dialog-centered modal-lg">
					  ...
					  <img class="inline-block" src="assets\img\user.jpg" alt="user">
                        ...
                        <?php }?>
										...
										$SQDepartstr="select * from department WHERE admin_id='$cont_hr_id' and parent_id='0' order by dep_name ASC";
				...
				<div id="add_employee" class="modal custom-modal fade" role="dialog">
					<div class="modal-dialog modal-dialog-centered modal-lg">
                        ...
                        <?php }} ?>
									...
									<div class="submit-section">
										<input type="hidden" name="admin_id" value="<?php echo $cont_hr_id;?>">
