...
$querybord="insert into department (dep_name,parent_id,admin_id,hr_id) values('$dep_name','$parent_id','$cont_hr_id','$hr_id')";
...
unset($_SESSION['destination_msg']); }?>
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<?php if($list_hr_permission['designation_wr']=='on' || $customerchechlogin_row['account_type'] == '1'){?>
							...
							<div>
								<table class="table table-striped custom-table mb-0 datatable">
									...
									<tbody>
										<?php
										$k = 1;
										$SQDepart="select * from department WHERE admin_id='$cont_hr_id' and parent_id!='0'";
										...
										<tr>
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
													<?php if($list_hr_permission['designation_red']=='on' || $customerchechlogin_row['account_type'] == '1'){?>
													...
													<?php } ?>
													<?php if($list_hr_permission['designation_del']=='on' || $customerchechlogin_row['account_type'] == '1'){?>
