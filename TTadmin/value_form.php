...
$sql_cms="select * from value_offered WHERE id=$id"; 
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php if(isset($_REQUEST['cms'])) { 
			  echo "Modify Projects- ".$row_cms['title'];
			  }
			  else
			  {
				echo "Add Projects";  
 ...
 ?> 
            ...
            <div class="box-body table-responsive">
              <div class="box box-primary"> 
                ...
                <form action="value_manage.php" method="post" enctype="multipart/form-data" name="cont"  id="myform" onSubmit="return validate();">
                  <div class="box-body">
                   ...
                   <div class="form-group">
                      ...
                      <?php if($row_cms['category']=='website'){?>
                      ...
                      <?php } else if($row_cms['category']=='seo'){?>
                      ...
                      <option value="api">API</option>
					  <option value="socialmedia">Social Media</option>
                       <?php } else if($row_cms['category']=='mobileapps'){?>
                      <option value="website" >Website</option>
                      <option value="seo">SEO</option>
                      <option value="mobileapps" selected>Mobile Apps</option>
                      <option value="graphic">Graphic</option>
					  <option value="api">API</option>
					  <option value="socialmedia">Social Media</option>
                      <?php }  else if($row_cms['category']=='graphic'){?>
                      <option value="website" >Website</option>
                      <option value="seo">SEO</option>
                      <option value="mobileapps">Mobile Apps</option>
					  ...
					  <option value="api">API</option>
					  <option value="socialmedia">Social Media</option>
					  <?php }  else if($row_cms['category']=='api'){?>
                    ...
                    <?php }  else if($row_cms['category']=='socialmedia'){?>
					<option value="api">API</option>
                      <option value="website">Website</option>
                      <option value="seo">SEO</option>
                      <option value="mobileapps">Mobile Apps</option>
                      <option value="graphic">Graphic</option>
					  <option value="socialmedia" selected>Social Media</option>
                      <?php } else {?>
                      <option value="website" >Website</option>
                      <option value="seo">SEO</option>
                      <option value="mobileapps">Mobile Apps</option>
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1"> Full Title</label>
                      <input type="text" name="fullname" class="form-control" id="exampleInputEmail1" placeholder="Enter Full title" value="<?php echo $row_cms['fullname']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="url" class="form-control" placeholder="Example : https://www.splendid.ae" id="exampleInputEmail1" value="<?php echo $row_cms['url']; ?>">
                    </div>
                     <div class="form-group">
                      <label for="exampleInputEmail1">Project Skill</label>
                      <input type="text" name="skill" class="form-control" id="tagsSpec" value="<?php echo $row_cms['skill']; ?>">
                    </div>
                     <div class="form-group" style="border:3px solid #f0ad4e; margin:10px 0; padding:10px;">
                    ...
                    <div class="form-group" style="border:3px solid #3c8dbc; margin:10px 0; padding:10px;">
                    <label for="exampleInputEmail1">Main Image</label>
                      ...
                      <img src="../uploads/<?php echo $row_cms['image3'];?>" width="<?php echo $width; ?>100" height="<?php echo $height; ?>" class="alignLeft" />
                      <?php } ?>
                    </div>
                    <div class="grid-x grid-padding-x">
  <div class="small-10 small-offset-1 medium-8 medium-offset-2 cell">
      <p>
        <label for="upload_imgs" class="button hollow">Select Multiple Image For Slider +  <span style="font-size:12px; color:#999; font-style:italic; margin-left:20px;">(Image size : 800px x 1069px)</span></label>
        <input class="show-for-sr" type="file" id="upload_imgs" name="image[]" value="<?php echo $row_cms['image']; ?>" multiple/>
...
$value; 
		  ?>     
      <img src="../	uploads/<?php echo $value;?>" class="img-preview-thumb" style="width:80px">
      <?php }}?>
...
<label for="exampleInputEmail1">Key features</label>
                      <textarea id="editor2" name="feature" rows="10"  cols="80">
                                            <?php echo $row_cms['feature']; ?>
                                        </textarea>
                    </div>
