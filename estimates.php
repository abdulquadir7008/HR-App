...
if(isset($_POST['add'])){
$querybord="insert into estimate (client,project,email,tax,client_address,billing_address,estimate_date,expire_date,status,othet_information,admin_id,ac_id) values('$client','$project','$email','$tax','$client_address','$billing_address','$estimate_date','$expire_date','1','$othet_information','$cont_hr_id','$ac_id')";
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<?php if($list_account_permission['estimates_wr']=='on' || $customerchechlogin_row['account_type'] == '1'){?>
							...
							<div class="table-responsive">
								<table class="table table-striped custom-table mb-0">
									...
									<tbody>
										...
										<?php
										$k= 1;
										$SQLestimate="select * from estimate WHERE admin_id=$cont_hr_id and status='1' AND client LIKE '%$search_employe%' $bwch order by estimate_id DESC";
											...
											<td class="text-right">
												<div class="dropdown dropdown-action">
													...
													<div class="dropdown-menu dropdown-menu-right">
														<?php if($list_account_permission['estimates_red']=='on' || $customerchechlogin_row['account_type'] == '1'){?>
														<a class="dropdown-item" href="estimate_form.php?edit=<?php echo $estimate_id;?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
														<?php } ?>
														<?php if($list_account_permission['estimates_del']=='on' || $customerchechlogin_row['account_type'] == '1'){?>
